...
import os
import json
def login(begin, contact, email, confirmEmail, phone, confirmPhone, name, username, password, confirmedPassword):
    ...
    if begin.upper() == "A":
        ...
        if contact.upper() == "A":
            ...
            #confirmPhone = input(f'Please confirm that your phone number is "{phone}". (Y/N)')
            if confirmPhone.upper() == "Y":
                #os.system("cls")
